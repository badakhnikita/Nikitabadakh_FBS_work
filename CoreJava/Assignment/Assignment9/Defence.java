...
//}
	...
	{
		return "\n name of head is"+this.nameOfHead+"\n no of mission"+this.noOfMission+"\n Budget is"+this.budget+"\n No of dept"+this.noOfDept+"\n Head quarter location"+this.headQuarterLocation+"\n country name is"+this.countryName+"\n man power count"+this.manpowercount;
	}
...
{
	super.toString();
 return "\n no of tanks"+this.noOfTank+"\n no of guns"+this.noOfGuns+"\n no of batallin"+this.noOfBatallin;
}
	 void attack()
	   {
		   System.out.println("attack by guns");
...
//	}
	...
	{
		super.toString();
		return "\n no of ships"+this.noOfShips+"\n no of submarine"+this.noOfSubmarine+"\n no of torpedoes"+this.noOfTorpedoes;
	}
	void attack()
	   {
		   System.out.println("attack by Torpedoes");
	   }
 }
...
//	}
	...
	void attack()
	   {
		   System.out.println("attack by missale");
	   }
 }
class Test7
{
