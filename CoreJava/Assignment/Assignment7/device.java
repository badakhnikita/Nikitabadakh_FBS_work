...
{
super.display();
System.out.println("Storage:"+this.ram);
System.out.println("Camera resolution:"+this.screensize);
}
...
m1.display();
Mobile m2=new Mobile("Apple","a746",75748,"white",128,64);
m2.display();
Laptop l1=new Laptop();
l1.display();
Laptop l2=new Laptop("Apple","a1334",94788,"black",128,12);
l2.display();
}//main end here;
}//class Test end here;
